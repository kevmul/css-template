<div class="Content">
    ...
    <div class="Grid--Flex is-spaced m-t-20">
        <div class="Card Column is-3-wide Background--Primary p-10">Is 3 Wide</div>
        <div class="Card Column is-6-wide Background--Primary p-10">Is 6 Wide</div>
        <div class="Card Column is-2-wide Background--Primary p-10">Is 2 Wide</div>
        <div class="Card Column is-1-wide Background--Primary p-10">Is 1 Wide</div>
    </div>
